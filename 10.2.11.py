# 10.2.11 Дополните приведенный код, чтобы он вывел имена всех пользователей
...
for i in users:
    if i['phone'].endswith('8'):
        print(i['name'], end=' ')
# v2 отработка только подходящих элементов, сортировка до
# print(*[i['name'] for i in list(filter(lambda x: x['phone'].endswith('8'), users))])

# v3 сбор в list с дальнейшей сортировкой
